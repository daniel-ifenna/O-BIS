    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <h1 className="text-2xl font-bold text-foreground">Vendor Wallet</h1>
          <p className="text-sm text-muted-foreground">Manage your earnings from supply contracts</p>
        </div>
      </header>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          ...
          <Card className="bg-gradient-to-br from-accent/10 to-accent/5 border-accent/20">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">Payment requests in review</p>
            </CardContent>
          </Card>
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex gap-4 flex-1">
                        ...
                        <div className="flex-1">
                          <p className="font-semibold">{tx.description || "Wallet Transaction"}</p>
