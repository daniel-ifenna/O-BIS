...
"[project]/app/api/procurements/[id]/quotes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_, { params }) {
    try {
        ...
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].vendorQuote.findMany({
            where: {
                procurementId: id
            },
            orderBy: {
        ...
        try {
            ...
            const item = (Array.isArray(arr) ? arr : []).find((p)=>String(p.id) === String(id));
...
async function POST(request, { params }) {
    try {
        ...
        try {
            const { id } = await params;
            const proc = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].procurementRequest.findUnique({
                where: {
                    id
                }
            });
            if (proc) {
                const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].vendorQuote.create({
                    data: {
                        procurementId: id,
                ...
                const normalized = {
                    ...created,
                    pricePerUnit: String(created.pricePerUnit),
                    totalPrice: String(created.totalPrice),
        ...
        try {
            ...
            const txt = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(fp, "utf8");
            const arr = JSON.parse(txt);
            const idx = (Array.isArray(arr) ? arr : []).findIndex((p)=>String(p.id) === String(id));
            if (idx < 0) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].writeFile(fp, JSON.stringify(arr, null, 2), "utf8");
            const normalized = {
                ...created,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5bdd1efe._.js.map