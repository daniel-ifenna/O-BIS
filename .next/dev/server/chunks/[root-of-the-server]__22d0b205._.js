...
async function POST(request, { params }) {
    try {
        ...
        let bid = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].bid.findUnique({
            where: {
                id
            }
        });
        ...
        if (!isOwner && String(project.managerId || "") !== String(auth.userId)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (includeAllShortlisted) {
            ...
            for (const b of shortlisted){
                ...
                try {
                    ...
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addBidInvitation"])({
                        bidId: b.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__22d0b205._.js.map