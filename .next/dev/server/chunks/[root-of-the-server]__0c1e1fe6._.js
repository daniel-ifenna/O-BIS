...
"[project]/app/api/reports/generate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (type === "financial-summary") {
            ...
            const paymentRequests = Array.isArray(body.paymentRequests) ? body.paymentRequests : [];
            ...
            const paymentRows = paymentRequests.map((pr)=>[
                    pr.requestedAt,
                    pr.requesterName,
                    pr.type,
                    pr.amount,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c1e1fe6._.js.map