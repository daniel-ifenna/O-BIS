...
"[project]/app/api/projects/[id]/daily-reports/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        try {
            ...
            let active = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].milestone.findFirst({
                where: {
                    projectId: id,
                    progress: {
                        lt: 100
            ...
            if (!active) {
                const now = new Date();
                active = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].milestone.create({
                    data: {
                        projectId: id,
                        name: "Auto-seeded",
                        startDate: now,
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].milestone.update({
                where: {
                    id: active.id
                },
                data: {
            ...
            const saved = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dailyReport.create({
                data: {
                    projectId: id,
            ...
            const { id } = await params;
            const list = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getMilestonesByProjectId"])(id).catch(()=>[]);
            let active = list.find((m)=>Number(m.progress || 0) < 100);
            if (!active) {
                const seeded = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setProjectMilestones"])(id, [
                    {
                        name: "Auto-seeded",
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateMilestoneProgress"])(id, active.id, nextProgress);
            const saved = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createDailyReport"])({
                projectId: String(id),
...
async function GET(_, { params }) {
    try {
        const { id } = await params;
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].dailyReport.findMany({
            where: {
                projectId: id
            },
            orderBy: {
        ...
        try {
            const { id } = await params;
            const items = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDailyReportsByProjectId"])(id);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(items);
        } catch  {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Failed to load daily reports"
            }, {
                status: 500
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6a4c3024._.js.map