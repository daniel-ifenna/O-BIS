...
"[project]/app/api/bids/[id]/status/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        let current = null;
        try {
            current = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].bid.findUnique({
                where: {
                    id
                }
            });
        } catch  {}
        if (!current) current = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBidById"])(id);
        ...
        if (status === "Reviewed" && current.status === "Reviewed") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(current);
        }
        if (status === "Awarded") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Use /api/bids/:id/award for awarding"
            }, {
                status: 400
            });
        }
        ...
        if (status === "Accepted" && ![
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Only shortlisted bids can be accepted"
            }, {
                status: 400
            });
        }
        ...
        let updated = null;
        try {
            updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].bid.update({
                where: {
                    id
                },
                data: {
        ...
        if (!updated) updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateBidById"])(id, {
            status,
        ...
        if (status === "Accepted") {
            try {
                ...
                const projectBids = await (async ()=>{
                    const { getBidsByProjectId } = await __turbopack_context__.A("[project]/lib/file-db.ts [app-route] (ecmascript, async loader)");
                    return getBidsByProjectId(current.projectId);
                })();
                for (const b of projectBids){
                    if (b.id !== id) await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateBidById"])(b.id, {
                        status: "Rejected",
                        reviewedAt: now.toISOString()
                    });
                }
            ...
            if (!user) {
                try {
                    user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["findUserByEmail"])(current.email);
                } catch  {}
            }
            if (!user) {
                const tempPassword = Math.random().toString(36).slice(2, 10) + "!A";
                const passwordHash = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2f$password$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(tempPassword);
                try {
                    ...
                    const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createUser"])({
                        ...
                        email: current.email,
                        role: "contractor",
                        company: current.companyName || undefined,
                        passwordHash
                    });
            ...
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$file$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateProjectById"])(current.projectId, {
                    status: "Active"
                });
            }
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__da1f0d32._.js.map