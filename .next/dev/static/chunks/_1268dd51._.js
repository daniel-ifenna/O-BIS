...
"[project]/lib/project-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProjectProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProjectProvider.useEffect": ()=>{
            const load = {
                "ProjectProvider.useEffect.load": async ()=>{
                    try {
                        ...
                        if (res.ok) {
                            ...
                            if (Array.isArray(items)) {
                                const normalized = items.map({
                                    "ProjectProvider.useEffect.load.normalized": (p)=>{
                                ...
                                }["ProjectProvider.useEffect.load.normalized"]);
            ...
            }["ProjectProvider.useEffect.load"];
            void load();
        }
    }["ProjectProvider.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const addProject = async (project)=>{
        try {
            const token = ("TURBOPACK compile-time value", "object") !== "undefined" && (localStorage.getItem("token") || localStorage.getItem("authToken") || localStorage.getItem("auth_token") || localStorage.getItem("managerToken") || "") || "";
            const res = await fetch("/api/projects", {
                method: "POST",
                headers: {
...
_s(ProjectProvider, "vlCY5Bnv5yvnBKL/KYxdgfMz1xo=");
_c = ProjectProvider;
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            if (savedUser) {
                try {
                    ...
                    fetch(`/api/auth/exists?email=${encodeURIComponent(parsedUser.email)}`).then({
...
"[project]/lib/procurement-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
const ProcurementContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function ProcurementProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProcurementProvider.useEffect": ()=>{
            const load = {
                "ProcurementProvider.useEffect.load": async ()=>{
                    try {
            ...
            }["ProcurementProvider.useEffect.load"];
            void load();
        }
    }["ProcurementProvider.useEffect"], []);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ProcurementContext.Provider, {
        value: {
            procurements,
            addProcurement,
            getProcurement,
...
_s(ProcurementProvider, "NEalFyjxIgSdTEyAqbx8pBVxEuw=");
_c = ProcurementProvider;
function useProcurements() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(ProcurementContext);
    if (!context) {
        throw new Error("useProcurements must be used within ProcurementProvider");
    }
    return context;
}
_s1(useProcurements, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "ProcurementProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/lib/complaint-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
const ComplaintContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function ComplaintProvider({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ComplaintContext.Provider, {
        value: {
            complaints,
            addComplaint,
            getComplaint,
...
_s(ComplaintProvider, "5PN/eltch3M08wVd59EeckddA1Y=");
_c = ComplaintProvider;
function useComplaints() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(ComplaintContext);
    if (!context) {
        throw new Error("useComplaints must be used within ComplaintProvider");
    }
    return context;
}
_s1(useComplaints, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "ComplaintProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/lib/payment-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(PaymentProvider, "BVfHARDuDX1kvYsyBs9AZLQhe/4=");
_c = PaymentProvider;
function usePayments() {
    _s1();
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(PaymentContext);
    if (!ctx) {
        throw new Error("usePayments must be used within PaymentProvider");
    }
    return ctx;
}
_s1(usePayments, "/dMy7t63NXD4eYACoT93CePwGrg=");
var _c;
...
"[project]/lib/bid-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const BidContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function BidProvider({ children }) {
    ...
    const { setProjectStatus, incrementBidCount, projects, updateProject } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$project$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useProjects"])();
    const [isLoaded, setIsLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [events, setEvents] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BidProvider.useEffect": ()=>{
            const load = {
                "BidProvider.useEffect.load": async ()=>{
                    try {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BidProvider.useEffect": ()=>{
            if (!isLoaded) return;
            setBids({
                "BidProvider.useEffect": (prev)=>{
                    let changed = false;
                    const next = prev.map({
                        "BidProvider.useEffect.next": (b)=>{
                            const byId = projects.find({
                                "BidProvider.useEffect.next.byId": (p)=>String(p.id) === String(b.projectId)
                            }["BidProvider.useEffect.next.byId"]);
                            if (byId) return b;
                            const key = String(b.projectId).toLowerCase();
                            const byTitle = projects.find({
                                "BidProvider.useEffect.next.byTitle": (p)=>p.title && p.title.toLowerCase() === key
                            }["BidProvider.useEffect.next.byTitle"]);
                            if (byTitle) {
                                changed = true;
                                return {
                                    ...b,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(BidContext.Provider, {
        value: {
            bids,
            getBidsByProject,
            submitBid,
...
_s(BidProvider, "MICyNSe9WhLEhfqkOEyyxoJLrFY=", false, function() {
    return [
...
function useBids() {
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(BidContext);
    if (!context) {
        throw new Error("useBids must be used within BidProvider");
    }
    return context;
}
_s1(useBids, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "BidProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
        ...
        "Toaster.useEffect": ()=>{
            try {
                ...
                try {
                    if ('caches' in window) {
                        caches.keys().then({
                            "Toaster.useEffect": (keys)=>keys.forEach({
                                    "Toaster.useEffect": (k)=>caches.delete(k)
                                }["Toaster.useEffect"])
                        }["Toaster.useEffect"]).catch({
                            "Toaster.useEffect": ()=>{}
                        }["Toaster.useEffect"]);
                    }
                } catch  {}
...
//# sourceMappingURL=_1268dd51._.js.map